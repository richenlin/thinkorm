            ...
            return _regenerator2.default.wrap(function _callee5$(_context5) {
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        ...
                        case 30:
                            return _context5.abrupt('return', this.__data[pk] || 0);
                ...
                while (1) {
                    switch (_context16.prev = _context16.next) {
                        case 0:
                            ...
                            return _context16.abrupt('return', this.error('_OPERATION_WRONG_'));
                        ...
                        case 6:
                            ...
                            return _context16.abrupt('return', this.error('query language error'));
                        ...
                        case 12:
                            ...
                            return _context16.abrupt('return', this.error('table name error'));
                    ...
                    if (_lib2.default.isArray(data)) {
                            ...
                            for (var n in item) {
                                if (fields[n] && typeCase[fields[n].type]) {
                                    switch (fields[n].type) {
                                        case 'json':
                                            if (_lib2.default.isEmpty(item[n])) {
                                                item[n] = {};
                                            } else {
                                                try {
                        ...
                        for (var n in data) {
                            if (fields[n] && typeCase[fields[n].type]) {
                                switch (fields[n].type) {
                                    case 'json':
                                        if (_lib2.default.isEmpty(data[n])) {
                                            data[n] = {};
                                        } else {
                                            try {
                                ...
                                return _regenerator2.default.wrap(function _callee17$(_context18) {
                                    while (1) {
                                        switch (_context18.prev = _context18.next) {
                                            case 0:
                                                relation = options.rel, rtype = void 0, config = _this4.config, ps = [];
                                                _context18.next = 3;
                                                return _this4.getPk();
                                            ...
                                            case 3:
                                                ...
                                                _loop = _regenerator2.default.mark(function _loop(n) {
                                                    var _loop2, _iterator, _isArray, _i, _ref18, _ret5;
