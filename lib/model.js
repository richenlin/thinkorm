        ...
        try {
            if (preCheck) {
                ...
                for (var _field3 in this.fields) {
                    //字段默认值处理
                    _lib2.default.isEmpty(data[_field3]) && (data[_field3] = !_lib2.default.isEmpty(this.fields[_field3].defaultTo) ? this.fields[_field3].defaultTo : data[_field3]);
                }
                if (result.length > 0) {
