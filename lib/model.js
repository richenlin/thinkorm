...
var _class = function (_base) {
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 3:
                            ...
                            return _context.abrupt('return', this.__model);
                        ...
                        case 5:
                            ...
                            return _context.abrupt('return', this.error('adapter ' + dbType + ' is not support.'));

                        case 8:
                            this.__model = new (_lib2.default.thinkRequire(adapterList[dbType]))(config);
                            return _context.abrupt('return', this.__model);
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 3:
                            ...
                            return _context2.abrupt('return', model.startTrans());
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        ...
                        case 3:
                            ...
                            return _context3.abrupt('return', model.commit());
                ...
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        ...
                        case 3:
                            ...
                            return _context4.abrupt('return', model.rollback());
    ...
    _class.prototype.add = function () {
        var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(data, options) {
            var parsedOptions, model, __data, result, pk;
                ...
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        ...
                        case 12:
                            ...
                            _context5.next = 15;
                            return this.__checkData(model, __data, parsedOptions, 'ADD');
                        ...
                        case 18:
                            _context5.next = 20;
                            return model.add(__data, parsedOptions);
                        ...
                        case 30:
                            return _context5.abrupt('return', __data[pk] || 0);
                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        ...
                        case 5:
                            ...
                            return _context6.abrupt('return', this.add(data, options));
    ...
    _class.prototype.update = function () {
        var _ref8 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee8(data, options) {
            var parsedOptions, model, __data, pk, result;
            ...
            return _regenerator2.default.wrap(function _callee8$(_context8) {
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        ...
                        case 10:
                            __data = _context8.sent;
                            _context8.next = 13;
                            return this.__checkData(model, __data, parsedOptions, 'UPDATE');
                        ...
                        case 13:
                            ...
                            return _context8.abrupt('return', this.error('_DATA_TYPE_INVALID_'));
                        ...
                        case 30:
                            _context8.next = 32;
                            return model.update(__data, parsedOptions);
    ...
    _class.prototype.increment = function () {
        var _ref9 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee9(field) {
            var step = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
            var options = arguments[2];

            var _lib$extend, parsedOptions, model, __data, result;
            ...
            return _regenerator2.default.wrap(function _callee9$(_context9) {
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        ...
                        case 16:
                            _context9.next = 18;
                            return model.increment(__data, field, parsedOptions);
        ...
        function increment(_x11, _x12, _x13) {
    ...
    _class.prototype.decrement = function () {
        var _ref10 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee10(field) {
            ...
            var _lib$extend2, parsedOptions, model, __data, result;
            ...
            return _regenerator2.default.wrap(function _callee10$(_context10) {
                while (1) {
                    switch (_context10.prev = _context10.next) {
                        ...
                        case 16:
                            _context10.next = 18;
                            return model.decrement(__data, field, parsedOptions);
        ...
        function decrement(_x15, _x16, _x17) {
                ...
                while (1) {
                    switch (_context13.prev = _context13.next) {
                        ...
                        case 9:
                            ...
                            _context13.next = 12;
                            return this.__parseData(model, (_lib2.default.isArray(result) ? result[0] : result) || {}, parsedOptions);
                ...
                while (1) {
                    switch (_context14.prev = _context14.next) {
                        ...
                        case 9:
                            ...
                            _context14.next = 12;
                            return this.__parseData(model, result || [], parsedOptions);
    ...
    _class.prototype.countSelect = function () {
        var _ref15 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee15(options, pageFlag) {
        ...
        function countSelect(_x24, _x25) {
    ...
    _class.prototype.query = function () {
        var _ref16 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee16(sqlStr) {
            var model, result;
                ...
                while (1) {
                    switch (_context16.prev = _context16.next) {
                        ...
                        case 3:
                            ...
                            _context16.next = 6;
                            return model.native(this.tableName, sqlStr);
    ...
    _class.prototype.__getRelationData = function () {
        var _ref17 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee18(adapter, options, data) {
            var _this3 = this;
                ...
                while (1) {
                    switch (_context19.prev = _context19.next) {
                        case 0:
                            ...
                            return _context19.delegateYield(_regenerator2.default.mark(function _callee17() {
                                        ...
                                        switch (_context18.prev = _context18.next) {
                                            ...
                                            case 3:
                                                ...
                                                _loop = _regenerator2.default.mark(function _loop(n) {
                                                    var _loop2, _iterator, _isArray, _i, _ref18, _ret4;

                                                    return _regenerator2.default.wrap(function _loop$(_context17) {
                                                        while (1) {
                                                            switch (_context17.prev = _context17.next) {
                                                                ...
                                                                case 16:
                                                                    data[relation[n]['name']] = _context17.sent;
                                                ...
                                                _context18.t0 = _regenerator2.default.keys(relation);
                                            ...
                                            case 6:
                                                ...
                                                n = _context18.t1.value;
                                                return _context18.delegateYield(_loop(n), 't2', 9);
                        ...
                        case 5:
                            return _context19.abrupt('return', relationData);
        ...
        function __getRelationData(_x29, _x30, _x31) {
    ...
    _class.prototype.__postRelationData = function () {
        var _ref20 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee19(adapter, result, options, relationData, postType) {
            ...
            return _regenerator2.default.wrap(function _callee19$(_context20) {
                while (1) {
                    switch (_context20.prev = _context20.next) {
                        ...
                        case 8:
                            return _context20.abrupt('return', _promise2.default.all(ps));

                        case 11:
                            _context20.prev = 11;
                            _context20.t0 = _context20['catch'](0);
                            return _context20.abrupt('return', this.error(_context20.t0));
        ...
        function __postRelationData(_x32, _x33, _x34, _x35, _x36) {
