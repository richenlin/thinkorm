...
var _class = function (_base) {
                    ...
                    switch (_context16.prev = _context16.next) {
                        case 0:
                            ...
                            return _context16.delegateYield(_regenerator2.default.mark(function _callee14() {
                                var relation, rtype, config, ps, _loop, n;
                                    ...
                                    while (1) {
                                        switch (_context15.prev = _context15.next) {
                                            ...
                                            case 3:
                                                ...
                                                return _context15.delegateYield(_loop(n), 't2', 6);
    ...
    _class.prototype.__postRelationData = function () {
        var _ref17 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee16(adapter, result, options, data, postType) {
            var caseList, ps, relation, rtype, config, relationData, n;
            return _regenerator2.default.wrap(function _callee16$(_context17) {
                while (1) {
                    switch (_context17.prev = _context17.next) {
                        case 0:
                            _context17.prev = 0;
                            caseList = { HASONE: adapter.__postHasOneRelation, HASMANY: adapter.__postHasManyRelation, MANYTOMANY: adapter.__postManyToManyRelation }, ps = [];
