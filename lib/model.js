...
var _class = function (_base) {
    ...
    _class.prototype.rel = function rel() {
        ...
        try {
            ...
            console.log(this.__options.rel);
            return this;
        } catch (e) {
            return this.error(e);
        }
            ...
            if (preCheck) {
                ...
                for (var _field2 in this.fields) {
                    if (method === 1) {
                        ...
                        //编辑数据
                        data.hasOwnProperty(_field2) && _lib2.default.isEmpty(data[_field2]) && (data[_field2] = this.fields[_field2].defaultTo ? this.fields[_field2].defaultTo : data[_field2]);
                    }
                }
                //根据规则自动验证数据
                if (options.verify) {
