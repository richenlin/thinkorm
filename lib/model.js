...
var _class = function (_base) {
    ...
    _class.prototype.init = function init() {
        ...
        // colleciton key
        this.clsKey = _schema2.default.getKey(this.config);
        // collection instance
        this.instances = null;
    };
                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        ...
                        case 23:
                            ...
                            _context6.next = 28;
                            return this.__postRelationData(result, parsedOptions, this.__relationData, 'ADD');
                ...
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        ...
                        case 32:
                            ...
                            _context9.next = 36;
                            return this.__postRelationData(result, parsedOptions, this.__relationData, 'UPDATE');
                ...
                while (1) {
                    switch (_context12.prev = _context12.next) {
                        ...
                        case 12:
                            ...
                            _context12.next = 17;
                            return this.__getRelationData(parsedOptions, result);
    ...
    _class.prototype.__getRelationData = function () {
        var _ref15 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee15(options, data) {
            var caseList, relationData, relation, rtype, fkey, scope, pk, n, _iterator, _isArray, _i, _ref16, _ref17, k, v;
                ...
                while (1) {
                    switch (_context15.prev = _context15.next) {
                        case 0:
                            ...
                            relation = options.rel, rtype = void 0, fkey = void 0, scope = this;
                            _context15.next = 7;
                            return this.getPk();
        ...
        function __getRelationData(_x20, _x21) {
    ...
    _class.prototype.__getHasOneRelation = function __getHasOneRelation(scope, rel, data) {
        var _where2;

        if (_lib2.default.isEmpty(data) || _lib2.default.isEmpty(data[rel.fkey])) {
            return {};
        }
        var model = new rel.model(scope.config);
    ...
    _class.prototype.__getHasManyRelation = function __getHasManyRelation(scope, rel, data) {
        var _where3;
    ...
    _class.prototype.__getManyToManyRelation = function __getManyToManyRelation(scope, rel, data) {
        var _where4;
        ...
        var model = new rel.model(scope.config);
        var rpk = model.getPk();
        var mapModel = new rel.mapModel(scope.config);
        //let mapName = `${rel.primaryName}${rel.name}Map`;
        //if(model.config.db_type === 'mongo'){
        return mapModel.field(rel.fkey).select({ where: (_where4 = {}, _where4[rel.fkey] = data[rel.primaryPk], _where4) }).then(function (data) {
            var _where5;
    ...
    _class.prototype.__postRelationData = function () {
        var _ref18 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee16(result, options, relationData, postType) {
            var caseList, relation, rtype, scope, pk, n;
                ...
                while (1) {
                    switch (_context16.prev = _context16.next) {
                        case 0:
                            ...
                            relation = _schema2.default.getRelation(this.modelName, this.config), rtype = void 0, scope = this;
                            _context16.next = 6;
                            return this.getPk();
                        ...
                        case 8:
                            ...
                            _context16.next = 15;
                            return caseList[rtype](scope, result, options, relation[n], relationData[n], postType);
        ...
        function __postRelationData(_x22, _x23, _x24, _x25) {
    ...
    _class.prototype.__postHasOneRelation = function () {
        var _ref19 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee17(scope, result, options, rel, relationData, postType) {
            var _primaryModel$update, _where6;

            var model, primaryModel, fkey, info, _where7;
            ...
            return _regenerator2.default.wrap(function _callee17$(_context17) {
                while (1) {
                    switch (_context17.prev = _context17.next) {
                        ...
                        case 2:
                            model = new rel.model(scope.config);
                            primaryModel = new ORM.collections[rel.clsKey][rel.primaryName](scope.config);
                            _context17.t0 = postType;
                            _context17.next = _context17.t0 === 'ADD' ? 7 : _context17.t0 === 'UPDATE' ? 15 : 25;
                            break;
                        ...
                        case 9:
                            ...
                            _context17.next = 14;
                            return primaryModel.update((_primaryModel$update = {}, _primaryModel$update[rel.fkey] = fkey, _primaryModel$update), { where: (_where6 = {}, _where6[rel.primaryPk] = result, _where6) });
        ...
        function __postHasOneRelation(_x26, _x27, _x28, _x29, _x30, _x31) {
    ...
    _class.prototype.__postHasManyRelation = function () {
        var _ref20 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee18(scope, result, options, rel, relationData, postType) {
            ...
            return _regenerator2.default.wrap(function _callee18$(_context18) {
                while (1) {
                    switch (_context18.prev = _context18.next) {
                        ...
                        case 2:
                            model = new rel.model(scope.config), rpk = model.getPk();
        ...
        function __postHasManyRelation(_x32, _x33, _x34, _x35, _x36, _x37) {
    ...
    _class.prototype.__postManyToManyRelation = function () {
        var _ref23 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee19(scope, result, options, rel, relationData, postType) {
            var _mapModel$thenAdd, _where9;

            var model, rpk, mapModel, _iterator3, _isArray3, _i3, _ref24, _ref25, k, v, fkey, _mapModel$thenAdd2, _where10, _where11;
                ...
                while (1) {
                    switch (_context19.prev = _context19.next) {
                        ...
                        case 2:
                            //子表主键
                            model = new rel.model(scope.config), rpk = model.getPk();
                            mapModel = new rel['mapModel'](scope.config);
                            //关系表
                        ...
                        case 15:
                            ...
                            _context19.next = _context19.t0 === 'ADD' ? 21 : _context19.t0 === 'UPDATE' ? 29 : 38;
                            break;
                        ...
                        case 23:
                            ...
                            _context19.next = 28;
                            return mapModel.thenAdd((_mapModel$thenAdd = {}, _mapModel$thenAdd[rel.fkey] = result, _mapModel$thenAdd[rel.rkey] = fkey, _mapModel$thenAdd), { where: (_where9 = {}, _where9[rel.fkey] = result, _where9[rel.rkey] = fkey, _where9) });
                        ...
                        case 29:
                            ...
                            _context19.next = 32;
                            return mapModel.thenAdd((_mapModel$thenAdd2 = {}, _mapModel$thenAdd2[rel.fkey] = v[rel.fkey], _mapModel$thenAdd2[rel.rkey] = v[rel.rkey], _mapModel$thenAdd2), { where: (_where10 = {}, _where10[rel.fkey] = v[rel.fkey], _where10[rel.rkey] = v[rel.rkey], _where10) });
        ...
        function __postManyToManyRelation(_x38, _x39, _x40, _x41, _x42, _x43) {
