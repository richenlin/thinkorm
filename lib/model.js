                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        ...
                        case 12:
                            ...
                            _context6.next = 15;
                            return this.__checkData(this.__data, parsedOptions, 1);
                ...
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        ...
                        case 10:
                            ...
                            _context9.next = 13;
                            return this.__checkData(this.__data, parsedOptions, 2);
        ...
        try {
            ...
            if (options.verify) {
                ...
                var _field2 = void 0,
                    value = void 0,
                    checkData = [];
                for (_field2 in this.validations) {
                    value = _lib2.default.extend(this.validations[_field2], { name: _field2, value: data[_field2] });
            ...
            //字段默认值处理
            for (var _field3 in this.fields) {
                if (method === 1) {
                    //新增数据add
                    _lib2.default.isEmpty(data[_field3]) && (data[_field3] = !_lib2.default.isEmpty(this.fields[_field3].defaultsTo) ? this.fields[_field3].defaultsTo : data[_field3]);
                } else if (method === 2) {
                    //编辑数据update
                    data.hasOwnProperty(_field3) && _lib2.default.isEmpty(data[_field3]) && (data[_field3] = !_lib2.default.isEmpty(this.fields[_field3].defaultsTo) ? this.fields[_field3].defaultsTo : data[_field3]);
                }
                //处理特殊类型字段
                if (adpCase[this.config.db_type] && data[_field3] && this.fields[_field3] && typeCase[this.fields[_field3].type]) {
