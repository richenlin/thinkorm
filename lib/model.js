...
module.exports = class {
    ...
    add(data, options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                ...
                let parsedOptions = helper.parseOptions(_this, options);
                // init db
                let db = _this.initDB();
                // copy data
                ...
                if (!lib.isEmpty(parsedOptions.rels)) {
                    yield relation.postRelationData(db, _data, _this.config, parsedOptions, data, 'ADD');
                }
    ...
    delete(options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                let parsedOptions = helper.parseOptions(_this3, options);
                if (lib.isEmpty(parsedOptions.where)) {
                    return _this3.error('_OPERATION_WRONG_');
                }
                // init db
                let db = _this3.initDB();
    ...
    update(data, options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                let parsedOptions = helper.parseOptions(_this4, options);
                // init db
                let db = _this4.initDB();
                // copy data
                let _data = lib.clone(data, true);
                _data = yield _this4._beforeAdd(data, parsedOptions);
                ...
                if (!lib.isEmpty(parsedOptions.rels)) {
                    yield relation.postRelationData(db, result, _this4.config, parsedOptions, data, 'UPDATE');
                }
    ...
    increment(field, step = 1, options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                let parsedOptions = helper.parseOptions(_this5, options);
                // init db
                let db = _this5.initDB();
                //copy data
    ...
    decrement(field, step = 1, options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                let parsedOptions = helper.parseOptions(_this6, options);
                // init db
                let db = _this6.initDB();
                //copy data
                let _data = { [field]: step };
    ...
    count(field, options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                let parsedOptions = helper.parseOptions(_this7, options);
                // init db
                let db = _this7.initDB();
    ...
    sum(field, options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                let parsedOptions = helper.parseOptions(_this8, options);
                // init db
                let db = _this8.initDB();
    ...
    find(options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                let parsedOptions = helper.parseOptions(_this9, options);
                // init db
                let db = _this9.initDB();
    ...
    select(options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                let parsedOptions = helper.parseOptions(_this10, options);
                // init db
                let db = _this10.initDB();
    ...
    countSelect(options) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            try {
                let parsedOptions = helper.parseOptions(_this11, options);
