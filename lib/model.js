...
var _class = function (_base) {
                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        ...
                        case 12:
                            ...
                            _context6.next = 15;
                            return this.__parseData(this.__data, parsedOptions, true, 1);
                ...
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        ...
                        case 10:
                            ...
                            _context9.next = 13;
                            return this.__parseData(this.__data, parsedOptions, true, 2);
                ...
                while (1) {
                    switch (_context12.prev = _context12.next) {
                        ...
                        case 9:
                            ...
                            _context12.next = 12;
                            return this.__parseData((_lib2.default.isArray(result) ? result[0] : result) || {}, parsedOptions, false);
                ...
                while (1) {
                    switch (_context13.prev = _context13.next) {
                        ...
                        case 9:
                            ...
                            _context13.next = 12;
                            return this.__parseData(result || [], parsedOptions, false);
    ...
    _class.prototype.query = function () {
        var _ref15 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee15(sqlStr) {
            var model, adpCase, quer, tableName;
                ...
                while (1) {
                    switch (_context15.prev = _context15.next) {
                        case 0:
                            ...
                            return _context15.abrupt('return', this.error('_OPERATION_WRONG_'));
                        ...
                        case 5:
                            ...
                            return _context15.abrupt('return', this.error('query language error'));
                        ...
                        case 11:
                            ...
                            return _context15.abrupt('return', this.error('table name error'));

                        case 15:
                            return _context15.abrupt('return', model.native(tableName, quer));

                        case 18:
                            return _context15.abrupt('return', model.native(sqlStr));
    ...
    _class.prototype.__parseData = function __parseData(data, options) {
        ...
        var method = arguments.length <= 3 || arguments[3] === undefined ? 0 : arguments[3];
            ...
            var _ret2 = function () {
                ...
                if (preCheck) {
                    ...
                    for (var field in data) {
                        if (_this3.fields[field]) {
                            if (_this3.fields[field].type) {
                                //字段类型严格验证
                                switch (_this3.fields[field].type) {
                                    case 'integer':
                                    case 'float':
                                        !_lib2.default.isNumber(data[field]) && result.push(field + '值类型错误');
                                        break;
                                    case 'json':
                                        !_lib2.default.isJSONObj(data[field]) && result.push(field + '值类型错误');
                                        break;
                                    case 'array':
                                        !_lib2.default.isArray(data[field]) && result.push(field + '值类型错误');
                                        break;
                                    case 'string':
                                    case 'text':
                                        !_lib2.default.isString(data[field]) && result.push(field + '值类型错误');
                                        break;
                                    default:
                                        break;
                                }
                            ...
                            //分离关联模型数据
                            if (_this3.relation[field]) {
                                !_this3.__relationData[field] && (_this3.__relationData[field] = {});
                                _this3.__relationData[field] = data[field];
                            }
                            //移除未定义的字段
                            delete data[field];
                        }
                    ...
                    if (result.length > 0) {
                        return {
                            v: _this3.error(result[0])
                        };
                    }
                    //根据规则自动验证数据
                    if (options.verify) {
                        if (_lib2.default.isEmpty(_this3.validations)) {
                            return {
                                v: data
                            };
                        }
                        var _field2 = void 0,
                            value = void 0,
                            checkData = [];
                        for (_field2 in _this3.validations) {
                            value = _lib2.default.extend(_this3.validations[_field2], { name: _field2, value: data[_field2] });
                        ...
                        result = {};
                        result = _this3.__valid(checkData);
                        ...
                        return {
                            v: _this3.error((0, _values2.default)(result)[0])
                        };
                    }

                    //字段默认值处理
                    for (var _field3 in _this3.fields) {
                        if (method === 1) {
                            //新增数据add
                            _lib2.default.isEmpty(data[_field3]) && (data[_field3] = !_lib2.default.isEmpty(_this3.fields[_field3].defaultsTo) ? _this3.fields[_field3].defaultsTo : data[_field3]);
                        } else if (method === 2) {
                            //编辑数据update
                            data.hasOwnProperty(_field3) && _lib2.default.isEmpty(data[_field3]) && (data[_field3] = !_lib2.default.isEmpty(_this3.fields[_field3].defaultsTo) ? _this3.fields[_field3].defaultsTo : data[_field3]);
                        }
                        //处理特殊类型字段
                        if (adpCase[_this3.config.db_type] && data[_field3] && _this3.fields[_field3] && typeCase[_this3.fields[_field3].type]) {
                            !_lib2.default.isString(data[_field3]) && (data[_field3] = (0, _stringify2.default)(data[_field3]));
                        }
                    }
                    return {
                        v: data
                    ...
                    if (adpCase[_this3.config.db_type]) {
                        if (_lib2.default.isArray(data)) {
                            data.map(function (item) {
                                for (var n in item) {
                                    if (_this3.fields[n] && typeCase[_this3.fields[n].type]) {
                                        item[n] = _lib2.default.isEmpty(item[n]) ? '' : JSON.parse((0, _stringify2.default)(item[n]));
                                    }
                                }
                            });
                            ...
                            for (var n in data) {
                                if (_this3.fields[n] && typeCase[_this3.fields[n].type]) {
                                    data[n] = _lib2.default.isEmpty(data[n]) ? '' : JSON.parse((0, _stringify2.default)(data[n]));
                                }
                            }
                        }
                    }
    ...
    _class.prototype.__getRelationData = function () {
        var _ref16 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee17(adapter, options, data) {
            var _this4 = this;
                ...
                while (1) {
                    switch (_context18.prev = _context18.next) {
                        case 0:
                            ...
                            return _context18.delegateYield(_regenerator2.default.mark(function _callee16() {
                                        ...
                                        switch (_context17.prev = _context17.next) {
                                            ...
                                            case 3:
                                                ...
                                                _loop = _regenerator2.default.mark(function _loop(n) {
                                                    var _loop2, _iterator, _isArray, _i, _ref17, _ret5;

                                                    return _regenerator2.default.wrap(function _loop$(_context16) {
                                                        while (1) {
                                                            switch (_context16.prev = _context16.next) {
                                                                ...
                                                                case 17:
                                                                    data[relation[n]['name']] = _context16.sent;
                                                ...
                                                _context17.t0 = _regenerator2.default.keys(relation);
                                            ...
                                            case 6:
                                                ...
                                                n = _context17.t1.value;
                                                return _context17.delegateYield(_loop(n), 't2', 9);
                        ...
                        case 5:
                            return _context18.abrupt('return', relationData);
        ...
        function __getRelationData(_x24, _x25, _x26) {
    ...
    _class.prototype.__postRelationData = function () {
        var _ref19 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee18(adapter, result, options, relationData, postType) {
            ...
            return _regenerator2.default.wrap(function _callee18$(_context19) {
                while (1) {
                    switch (_context19.prev = _context19.next) {
                        ...
                        case 8:
                            return _context19.abrupt('return', _promise2.default.all(ps));

                        case 11:
                            _context19.prev = 11;
                            _context19.t0 = _context19['catch'](0);
                            return _context19.abrupt('return', this.error(_context19.t0));
        ...
        function __postRelationData(_x27, _x28, _x29, _x30, _x31) {
