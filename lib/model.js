...
var _class = function (_base) {
                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        ...
                        case 12:
                            ...
                            _context6.next = 15;
                            return this._parseData(this.__data, parsedOptions, true, 1);
                ...
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        ...
                        case 10:
                            ...
                            _context9.next = 13;
                            return this._parseData(this.__data, parsedOptions, true, 2);
        ...
        try {
            if (preCheck) {
                        ...
                        if (this.fields[field].type) {
                            ...
                            switch (this.fields[field].type) {
                                ...
                                case 'float':
                                    ...
                                    break;
                                case 'json':
                                    !_lib2.default.isJSONObj(data[field]) && !_lib2.default.isJSONStr(data[field]) && result.push(field + '值类型错误');
                                    break;
                                case 'string':
                                case 'text':
                ...
                for (var _field2 in this.fields) {
                    if (method === 1) {
                        //新增数据
                        _lib2.default.isEmpty(data[_field2]) && (data[_field2] = this.fields[_field2].defaultsTo ? this.fields[_field2].defaultsTo : data[_field2]);
                    } else if (method === 2) {
                        //编辑数据
                        data.hasOwnProperty(_field2) && _lib2.default.isEmpty(data[_field2]) && (data[_field2] = this.fields[_field2].defaultsTo ? this.fields[_field2].defaultsTo : data[_field2]);
                    }
                }
                //根据规则自动验证数据
                if (options.verify) {
                    ...
                    var _field3 = void 0,
                        value = void 0,
                        checkData = [];
                    for (_field3 in this.validations) {
                        value = _lib2.default.extend(this.validations[_field3], { name: _field3, value: data[_field3] });
    ...
    _class.prototype.__getRelationData = function () {
        var _ref15 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee16(adapter, options, data) {
            var _this3 = this;
                ...
                while (1) {
                    switch (_context17.prev = _context17.next) {
                        case 0:
                            ...
                            return _context17.delegateYield(_regenerator2.default.mark(function _callee15() {
                                ...
                                return _regenerator2.default.wrap(function _callee15$(_context16) {
                                    while (1) {
                                        switch (_context16.prev = _context16.next) {
                                            case 0:
                                                relation = options.rel, rtype = void 0, fkey = void 0, config = _this3.config, ps = [];
                                                _context16.next = 3;
                                                return _this3.getPk();
                                            ...
                                            case 3:
                                                ...
                                                _loop = _regenerator2.default.mark(function _loop(n) {
                                                    var _loop2, _iterator, _isArray, _i, _ref16, _ret4;
                                                    ...
                                                    return _regenerator2.default.wrap(function _loop$(_context15) {
                                                        while (1) {
                                                            switch (_context15.prev = _context15.next) {
                                                                ...
                                                                case 17:
                                                                    data[relation[n]['name']] = _context15.sent;
                                                ...
                                                _context16.t0 = _regenerator2.default.keys(relation);
                                            ...
                                            case 6:
                                                ...
                                                return _context16.delegateYield(_loop(n), 't2', 9);
                        ...
                        case 5:
                            return _context17.abrupt('return', relationData);

                        case 8:
                            _context17.prev = 8;
                            _context17.t1 = _context17['catch'](0);
                            return _context17.abrupt('return', this.error(_context17.t1));
        ...
        function __getRelationData(_x23, _x24, _x25) {
    ...
    _class.prototype.__postRelationData = function () {
        var _ref18 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee17(adapter, result, options, relationData, postType) {
            ...
            return _regenerator2.default.wrap(function _callee17$(_context18) {
                while (1) {
                    switch (_context18.prev = _context18.next) {
                        ...
                        case 8:
                            return _context18.abrupt('return', _promise2.default.all(ps));

                        case 11:
                            _context18.prev = 11;
                            _context18.t0 = _context18['catch'](0);
                            return _context18.abrupt('return', this.error(_context18.t0));
        ...
        function __postRelationData(_x26, _x27, _x28, _x29, _x30) {
