...
const validData = function (fields, data, vaildRules, method = '') {
    ...
    for (let field in fields) {
        if (method === 'ADD') { //新增数据add
            if (lib.isEmpty(data[field]) && (fields[field].default !== undefined && fields[field].default !== null)) {
            ...
            if (data[field] !== undefined && lib.isEmpty(data[field]) && (fields[field].default !== undefined && fields[field].default !== null)) {
                data[field] = fields[field].default;
            }
