...
module.exports = function tokenizer(inputs) {
  ...
  var DML_IDENTIFIERS = ['select', 'insert', 'update', 'del'];
    ...
    _.each(value, function processJoinInstructions(joinInstructions) {
      ...
      if (_.isArray(joinInstructions.on)) {
        (function andInstructions() {
          ...
          var joinResults = [{ type: 'KEY', value: 'TABLE' }, { type: 'VALUE', value: JOIN_TABLE }];
          ...
          _.each(joinInstructions.on, function onSet(set) {
            ...
            var setKeys = [{ type: 'COMBINATOR', value: 'AND' }, { type: 'KEY', value: 'TABLE_KEY' }, { type: 'VALUE', value: PARENT_TABLE }, { type: 'KEY', value: 'COLUMN_KEY' }, { type: 'VALUE', value: PARENT_COLUMN }, { type: 'KEY', value: 'TABLE_KEY' }, { type: 'VALUE', value: CHILD_TABLE }, { type: 'KEY', value: 'COLUMN_KEY' }, { type: 'VALUE', value: CHILD_COLUMN }];
        ...
        (function orInstructions() {
          ...
          _.each(joinInstructions.on.or, function orSet(set) {
            ...
            var setKeys = [{ type: 'COMBINATOR', value: 'OR' }, { type: 'KEY', value: 'TABLE_KEY' }, { type: 'VALUE', value: PARENT_TABLE }, { type: 'KEY', value: 'COLUMN_KEY' }, { type: 'VALUE', value: PARENT_COLUMN }, { type: 'KEY', value: 'TABLE_KEY' }, { type: 'VALUE', value: CHILD_TABLE }, { type: 'KEY', value: 'COLUMN_KEY' }, { type: 'VALUE', value: CHILD_COLUMN }];
        ...
        (function buildJoinResults() {
          ...
          var joinResults = [{ type: 'KEY', value: 'TABLE' }, { type: 'VALUE', value: JOIN_TABLE }, { type: 'KEY', value: 'TABLE_KEY' }, { type: 'VALUE', value: PARENT_TABLE }, { type: 'KEY', value: 'COLUMN_KEY' }, { type: 'VALUE', value: PARENT_COLUMN }, { type: 'KEY', value: 'TABLE_KEY' }, { type: 'VALUE', value: CHILD_TABLE }, { type: 'KEY', value: 'COLUMN_KEY' }, { type: 'VALUE', value: CHILD_COLUMN }];
