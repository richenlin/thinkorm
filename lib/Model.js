...
var _class = function (_base) {
            ...
            if (ORM.isObject(onCondition)) {
                ...
                if (onCondition.or != undefined) {
                    ...
                    for (var _k in onCondition) {
                        on.push('' + this.tablePrefix + _k + '.' + onCondition[_k]);
                    }
    ...
    _class.prototype.__getRelationData = function () {
        var _ref28 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee24(result, options) {
            var o;
    ...
    _class.prototype.__getRelationOptions = function () {
        var _ref29 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee25(data, option) {
                ...
                while (1) {
                    switch (_context25.prev = _context25.next) {
                        ...
                        case 39:
                            ...
                            _context25.t0 = _regenerator2.default.keys(relation);
                        ...
                        case 53:
                            return _context25.abrupt('return', relationObj);
    ...
    _class.prototype.__getHasOneRelation = function () {
        var _ref32 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee26(self, data, relation) {
    ...
    _class.prototype.__getHasManyRelation = function () {
        var _ref35 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee27(self, data, relation) {
                ...
                while (1) {
                    switch (_context27.prev = _context27.next) {
                        ...
                        case 10:
                            ...
                            return _context27.abrupt('break', 30);
                ...
                while (1) {
                    switch (_context28.prev = _context28.next) {
                        ...
                        case 7:
                            ...
                            return _context28.abrupt('break', 21);
                        ...
                        case 41:
                            ...
                            option.join = [{
                                from: relation.model,
                                on: (_on = {}, _on[relation.model] = key, _on['' + options.table.substring(self.config.db_prefix.length)] = rfkey, _on)
                            }];
                            _context28.next = 49;
                        ...
                        case 54:
                            ...
                            option.join = [{
                                from: relation.model,
                                on: (_on2 = {}, _on2[relation.model] = key, _on2['' + options.table.substring(self.config.db_prefix.length)] = rfkey, _on2)
                            }];
                            _context28.next = 59;
                            return model.where(option.where).join(option.join).select(options);
    ...
    _class.prototype.__getBelongsToRealtion = function () {
        var _ref42 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee29(self, data, relation) {
            ...
            return _regenerator2.default.wrap(function _callee29$(_context29) {
                while (1) {
                    switch (_context29.prev = _context29.next) {
                        ...
                        case 27:
                            data[k][relation.name] = _context29.sent;
                        ...
                        case 36:
                            data[relation.name] = _context29.sent;
    ...
    _class.prototype.__postRelationData = function () {
        var _ref45 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee30(result, data, postType, options) {
            var _this3 = this;
