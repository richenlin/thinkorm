...
var _class = function (_base) {
                ...
                while (1) {
                    switch (_context13.prev = _context13.next) {
                        ...
                        case 8:
                            ...
                            _context13.next = 11;
                            return this.adapter().insert(data, options);
                        ...
                        case 11:
                            ...
                            _context13.next = 17;
                            return this.__postRelationData(data[this.pk], this._data, 'ADD', options);
                        ...
                        case 20:
                            return _context13.abrupt('return', data[pk]);
                ...
                while (1) {
                    switch (_context16.prev = _context16.next) {
                        case 0:
                            ...
                            return _context16.abrupt('return', ORM.error('DATA MUST BE ARRAY'));
                        ...
                        case 4:
                            ...
                            return _context16.delegateYield(_regenerator2.default.mark(function _callee15() {
                                var pk, count, ps, resule;
                                return _regenerator2.default.wrap(function _callee15$(_context15) {
                                    while (1) {
                                        switch (_context15.prev = _context15.next) {
                                            case 0:
                                                pk = _this2.getPk(), count = 0, ps = void 0;

                                                ps = data.map(function (item) {
                                                    var _item = ORM.extend({}, item);
                                                    return _this2.parseData(item, options, 1).then(function (item) {
                                                        return _this2.adapter().insert(item, options);
                                                    }).then(function () {
                                                        _item[pk] = item[pk] = _this2.adapter().getLastInsertId();
                                                        return _this2.__postRelationData(_item[pk], _item, 'ADD', options);
                                                    }).then(function () {
                                                        return 1;
                                                    });
                                                });
    ...
    _class.prototype.update = function () {
        var _ref21 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee17(data, options) {
            var result;
                ...
                while (1) {
                    switch (_context17.prev = _context17.next) {
                        case 0:
                            ...
                            return _context17.abrupt('return', ORM.error('_DATA_TYPE_INVALID_'));
                        ...
                        case 4:
                            ...
                            this._data = ORM.extend({}, data);
                            _context17.next = 8;
                            return this.parseData(data, options, 2);

                        case 8:
                            data = _context17.sent;
                            _context17.next = 11;
                            return this.adapter().update(data, options);
                        ...
                        case 11:
                            ...
                            _context17.next = 15;
                            return this.__postRelationData(result, this._data, 'UPDATE', options);
    ...
    _class.prototype._afterUpdate = function () {
        var _ref22 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee18(data, options) {
            return _regenerator2.default.wrap(function _callee18$(_context18) {
                while (1) {
                    switch (_context18.prev = _context18.next) {
                        case 0:
                            return _context18.abrupt('return', _promise2.default.resolve(data));
    ...
    _class.prototype._beforeDelte = function () {
        var _ref23 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee19(options) {
            return _regenerator2.default.wrap(function _callee19$(_context19) {
                while (1) {
                    switch (_context19.prev = _context19.next) {
                        case 0:
                            return _context19.abrupt('return', _promise2.default.resolve(options));
    ...
    _class.prototype.delete = function () {
        var _ref24 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee20(options) {
            var result;
    ...
    _class.prototype._afterDelte = function () {
        var _ref25 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee21(options) {
    ...
    _class.prototype.parseOptions = function () {
        var _ref26 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee22(oriOpts, extraOptions) {
            var options;
                ...
                while (1) {
                    switch (_context22.prev = _context22.next) {
                        case 0:
                            ...
                            return _context22.abrupt('return', options);
    ...
    _class.prototype.parseData = function () {
        var _ref27 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee23(data, options) {
    ...
    _class.prototype.__getRelationData = function __getRelationData(result, options) {
        var o = void 0;
    ...
    _class.prototype.__getRelationOptions = function () {
        var _ref28 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee24(data, option) {
            var relation, _iterator6, _isArray6, _i6, _ref29, k, _iterator7, _isArray7, _i7, _ref30, _k2, caseList, relationObj, item, _k3, type;
        ...
        function __getRelationOptions(_x47, _x48) {
    ...
    _class.prototype.__getHasOneRelation = function () {
        var _ref31 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee25(self, data, relation) {
            var Model, model, key, fkey, where, _iterator8, _isArray8, _i8, _ref32, _ref33, k, v;
        ...
        function __getHasOneRelation(_x49, _x50, _x51) {
    ...
    _class.prototype.__getHasManyRelation = function () {
        var _ref34 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee26(self, data, relation) {
            var Model, model, key, fkey, where, _iterator9, _isArray9, _i9, _ref35, _ref36, k, v;
        ...
        function __getHasManyRelation(_x52, _x53, _x54) {
    ...
    _class.prototype.__getManyToManyRelation = function () {
        var _ref37 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee27(self, data, relation) {
            var Model, model, modelTableName, option, options, field, _iterator10, _isArray10, _i10, _ref38, f, key, fkey, where, rfkey, _iterator11, _isArray11, _i11, _on, _ref39, _ref40, k, v, _on2;
        ...
        function __getManyToManyRelation(_x55, _x56, _x57) {
    ...
    _class.prototype.__getBelongsToRealtion = function () {
        var _ref41 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee28(self, data, relation) {
            var Model, model, key, fkey, where, _iterator12, _isArray12, _i12, _ref42, _ref43, k, v;
        ...
        function __getBelongsToRealtion(_x58, _x59, _x60) {
    ...
    _class.prototype.__postRelationData = function () {
        var _ref44 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee29(result, data, postType, options) {
            var _this3 = this;
                    ...
                    switch (_context29.prev = _context29.next) {
                        case 0:
                            ...
                            promises = (0, _keys2.default)(this.relation).map(function (key) {
                                ...
                                if (type && type in caseList) {
                                    return caseList[type](_this3, data, data[key], postType, item);
                                }
                            });
                            _context29.next = 5;
        ...
        function __postRelationData(_x61, _x62, _x63, _x64) {
    ...
    _class.prototype.__postHasOneRelation = function __postHasOneRelation(self, data, childdata, postType, relation) {
        var _model$where;

        //let model = ORM.model(relation.model, {});
        var Model = require('../index');
        var model = new Model(relation.model, self.config);
        var key = relation.key || self.getPk();
        var fkey = relation.fkey || self.getModelName().toLowerCase() + '_id';
        //子表外键数据
    ...
    _class.prototype.__postHasManyRelation = function __postHasManyRelation(self, data, childdata, postType, relation) {
        //let model = ORM.model(relation.model, {});
        var Model = require('../index');
        var model = new Model(relation.model, self.config);
        var key = relation.key || self.getPk();
    ...
    _class.prototype.__postManyToManyRelation = function __postManyToManyRelation(self, data, childdata, postType, relation) {
        //let model = ORM.model(relation.model, {});
        var Model = require('../index');
        var model = new Model(relation.model, self.config);
        var option = {};
        ...
        var rpk = model.getPk(),
            cid = void 0;
        var rkey = model.relation.key || rpk;
        var rfkey = model.relation.fkey || model.getModelName().toLowerCase() + '_id';
        if (ORM.isArray(childdata)) {
            childdata.map(function (cdata) {
                switch (postType) {
                    case 'ADD':
                        //先写入关联表
                        model.add(cdata).then(function (cid) {
                            var _self$adapter$insert;

                            cdata[rpk] = cid;
                            //写入两个表关系表
                            self.adapter().insert((_self$adapter$insert = {}, _self$adapter$insert[fkey] = data[key], _self$adapter$insert[rfkey] = cdata[rkey], _self$adapter$insert), option);
                        });
                        break;
                    case 'UPDATE':
                        break;
            ...
            switch (postType) {
                case 'ADD':
                    //先写入关联表
                    model.add(childdata).then(function (cid) {
                        var _self$adapter$insert2;

                        childdata[rpk] = cid;
                        self.adapter().insert((_self$adapter$insert2 = {}, _self$adapter$insert2[fkey] = data[key], _self$adapter$insert2[rfkey] = childdata[rkey], _self$adapter$insert2), option);
                    });
                    break;
                case 'UPDATE':
                    //先从两表关系表查出对应关系表的外键
