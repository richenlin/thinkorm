...
var _class = function (_base) {
        ...
        var parse = function parse(key, value, k) {
            ...
            switch (identifiers[key]) {
                ...
                case 'NOT':
                    for (var _n in value) {
                        if (isor) {
                            self._options.where.orwhere.not.push([_n, value[_n]]);
                        } else {
                            self._options.where.where.not.push([_n, value[_n]]);
                        }
                    }
                ...
                case 'NOTIN':
                    ...
                    for (var _n2 in value) {
                        if (isor) {
                            self._options.where.orwhere.notin.push([_n2, value[_n2]]);
                        } else {
                            self._options.where.where.notin.push([_n2, value[_n2]]);
                        }
                    }
                    break;
                case 'OPERATOR':
    ...
    _class.prototype.update = function () {
        var _ref19 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee14(data, options) {
    ...
    _class.prototype.parseOptions = function () {
        var _ref20 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee15(oriOpts, extraOptions) {
            var options;
        ...
        function parseOptions(_x32, _x33) {
    ...
    _class.prototype.parseData = function () {
        ...
        function parseData(_x34, _x35, _x36) {
