...
var thinkorm = function (_base) {
    ...
    thinkorm.prototype._postRelationData = function () {
        var _ref13 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee11(result, options, relationData, postType) {
            var caseList, resultData, relation, newClass, rtype, scope, pk, n;
                ...
                while (1) {
                    switch (_context12.prev = _context12.next) {
                        ...
                        case 2:
                            ...
                            _context12.next = _context12.t0 === 'ADD' ? 6 : _context12.t0 === 'UPDATE' ? 11 : 15;
                            break;
                        ...
                        case 8:
                            ...
                            //更新主表关联字段
                            fkey && scope.update((_scope$update = {}, _scope$update[rel.fkey] = fkey, _scope$update), { where: (_where5 = {}, _where5[rel.pk] = result, _where5), table: '' + scope.config.db_prefix + rel.pmodel, name: rel.pmodel });
                ...
                while (1) {
                    switch (_context13.prev = _context13.next) {
                        ...
                        case 2:
                            ...
                            _context13.next = _context13.t0 === 'ADD' ? 6 : _context13.t0 === 'UPDATE' ? 12 : 32;
                            break;

                        case 6:
                            //子表插入数据
                            relationData[rel.rkey] = relationData[rel.pk];
                            _context13.t1 = relationData[rel.rkey];
                ...
                while (1) {
                    switch (_context14.prev = _context14.next) {
                        ...
                        case 2:
                            ...
                            _context14.next = _context14.t0 === 'ADD' ? 7 : _context14.t0 === 'UPDATE' ? 9 : 10;
                            break;

                        case 7:
                            //子表增加数据
                            fkey = scope.add(relationData, { table: '' + scope.config.db_prefix + rel.model, name: rel.model });
                            //关系表增加数据
                            //fkey && (scope.thenAdd({[]}));
