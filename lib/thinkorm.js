...
var _class = function (_base) {
                                    ...
                                    while (1) {
                                        switch (_context3.prev = _context3.next) {
                                            ...
                                            case 16:
                                                _this2._data = _context3.sent;
                                                _context3.next = 19;
                                                return model.addAll(_this2._data, parsedOptions);
    ...
    _class.prototype.update = function () {
        var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee7(data, options) {
            var parsedOptions, model, _pk, result;
                ...
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        ...
                        case 16:
                            ...
                            if (ORM.isEmpty(this._data[_pk])) {
                                _context7.next = 24;
                                break;
                            }

                            parsedOptions.where = {};
                            parsedOptions.where[_pk] = this._data[_pk];
                            delete this._data[_pk];
                            _context7.next = 25;
                            break;
    ...
    _class.prototype.count = function () {
        var _ref6 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee8(field, options) {
            var parsedOptions, _pk2, model, result;
    ...
    _class.prototype.sum = function () {
        var _ref7 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee9(field, options) {
            var parsedOptions, _pk3, model, result;
