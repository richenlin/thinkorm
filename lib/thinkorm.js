                                    ...
                                    while (1) {
                                        switch (_context3.prev = _context3.next) {
                                            ...
                                            case 16:
                                                _this3._data = _context3.sent;
                                                _context3.next = 19;
                                                return db.addAll(_this3._data, parsedOptions);
                ...
                while (1) {
                    switch (_context10.prev = _context10.next) {
                        ...
                        case 9:
                            ...
                            _context10.next = 12;
                            return this._parseData(ORM.isArray(result) ? result[0] : result, parsedOptions, false);
        ...
        if (ORM.isEmpty(this.relation)) {
            ...
            var _ret3 = function () {
                ...
                var scope = function (_thinkorm) {
                    ...
                    relationOptions = {};
                _this5.relation.forEach(function (rel) {
                    var type = rel.type || '';
                    if (type == 1) {
                        type = 'HASONE';
                    } else if (type == 2) {
