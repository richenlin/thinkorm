...
var thinkorm = function (_base) {
                    ...
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            ...
                            return _context4.delegateYield(_regenerator2.default.mark(function _callee3() {
                                var parsedOptions, db, promisesd, promiseso, result, _ret2;
                                ...
                                return _regenerator2.default.wrap(function _callee3$(_context3) {
                                    while (1) {
                                        switch (_context3.prev = _context3.next) {
                                            ...
                                            case 2:
                                                _context3.next = 4;
                                                return _this2._parseOptions(options);

                                            case 4:
                                                parsedOptions = _context3.sent;
                                                _context3.next = 7;
                                                return _this2.initDb();
                                            ...
                                            case 12:
                                                ...
                                                promiseso = _this2._data.map(function (item) {
                                                    return _this2._parseData(item, parsedOptions);
                                                });
                                                _context3.next = 16;
                                            ...
                                            case 16:
                                                _this2._data = _context3.sent;
                                                _context3.next = 19;
                                                return db.addAll(_this2._data, parsedOptions);

                                            case 19:
                                                result = _context3.sent;
                                                _context3.next = 22;
                                                return _this2._parseData(result || [], parsedOptions, false);
    ...
    thinkorm.prototype._getRelationData = function _getRelationData(db, options, config) {
        var _this4 = this;
        ...
        if (ORM.isEmpty(this.relation)) {
            ...
            var _ret3 = function () {
                //类作用域
                var scope = function (_thinkorm) {
                    (0, _inherits3.default)(scope, _thinkorm);
                    ...
                    relationOptions = {};
                _this4.relation.forEach(function (rel) {
                    var type = rel.type || '';
                    if (type == 1) {
                        type = 'HASONE';
                    } else if (type == 2) {
    ...
    thinkorm.prototype._parseRelationData = function _parseRelationData(db, options, data) {
        var caseList = {
        ...
        if (ORM.isEmpty(this.relation)) {
            ...
            this.relation.forEach(function (rel) {
                var type = rel.type || '';
                if (type == 1) {
                    type = 'HASONE';
                } else if (type == 2) {
