...
var _class = function () {
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 12:
                            this._data = _context.sent;
                            _context.next = 15;
                            return this.initDb().add(this._data, parsedOptions);
                                    ...
                                    while (1) {
                                        switch (_context3.prev = _context3.next) {
                                            ...
                                            case 13:
                                                _this._data = _context3.sent;
                                                _context3.next = 16;
                                                return _this.initDb().addAll(_this._data, parsedOptions);
                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        ...
                        case 3:
                            ...
                            return _context6.abrupt('return', this.error('_OPTION_TYPE_INVALID_'));
                        ...
                        case 8:
                            _context6.next = 10;
                            return this.initDb().delete(parsedOptions);
                ...
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        ...
                        case 3:
                            ...
                            return _context7.abrupt('return', this.error('_OPTION_TYPE_INVALID_'));
                ...
                while (1) {
                    switch (_context10.prev = _context10.next) {
                        ...
                        case 3:
                            ...
                            _context10.next = 6;
                            return this.initDb().find(parsedOptions);
                        ...
                        case 9:
                            result = _context10.sent;
                            return _context10.abrupt('return', this._afterFind(ORM.isArray(result) ? result[0] : result, options));
                ...
                while (1) {
                    switch (_context11.prev = _context11.next) {
                        ...
                        case 3:
                            ...
                            _context11.next = 6;
                            return this.initDb().select(parsedOptions);
    ...
    _class.prototype.countSelect = function () {
        ...
        function countSelect(_x22, _x23) {
