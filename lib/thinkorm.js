...
var _class = function () {
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 12:
                            this._data = _context.sent;
                            _context.next = 15;
                            return this.db().add(this._data, parsedOptions);
                    ...
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            ...
                            return _context4.delegateYield(_regenerator2.default.mark(function _callee3() {
                                var parsedOptions, promisesd, promiseso, result, _ret2;
                                        ...
                                        switch (_context3.prev = _context3.next) {
                                            case 0:
                                                ...
                                                return _context3.abrupt('return', {
                                                    v: _this.error('_DATA_TYPE_INVALID_')
                                                });

                                            case 2:
                                                _context3.next = 4;
                                                return _this.parseOptions(options);

                                            case 4:
                                                parsedOptions = _context3.sent;

                                                //copy data
                                                _this._data = ORM.extend([], data);
                                                promisesd = _this._data.map(function (item) {
                                                    return _this._beforeAdd(item, parsedOptions);
                                                });
                                                _context3.next = 9;
                                                return _promise2.default.all(promisesd);

                                            case 9:
                                                _this._data = _context3.sent;
                                                promiseso = _this._data.map(function (item) {
                                                    return _this.parseData(item, parsedOptions);
                                                });
                                                _context3.next = 13;
                                            ...
                                            case 13:
                                                _this._data = _context3.sent;
                                                _context3.next = 16;
                                                return _this.db().addAll(_this._data, parsedOptions);
                                                            ...
                                                            switch (_context2.prev = _context2.next) {
                                                                ...
                                                                case 2:
                                                                    ...
                                                                    result.forEach(function (v, k) {
                                                                        _this._data[k][pk] = v;
                                                                        resData.push(_this._afterAdd(_this._data[k], parsedOptions).then(function () {
                                                                            return v;
                                                                        }));
                                                                    });
    ...
    _class.prototype.delete = function () {
        var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(options) {
    ...
    _class.prototype.count = function () {
        var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee7(field, options) {
    ...
    _class.prototype.find = function () {
        var _ref7 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee9(options) {
                ...
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        ...
                        case 3:
                            ...
                            _context9.next = 6;
                            return this.db().find(parsedOptions);
                        ...
                        case 9:
                            result = _context9.sent;
                            return _context9.abrupt('return', this._afterFind(ORM.isArray(result) ? result[0] : result, options));
            ...
            return _regenerator2.default.wrap(function _callee10$(_context10) {
                while (1) {
                    switch (_context10.prev = _context10.next) {
                        ...
                        case 9:
                            result = _context10.sent;
                            return _context10.abrupt('return', this._afterSelect(result, options));
    ...
    _class.prototype.countSelect = function () {
        var _ref9 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee11(options, pageFlag) {
