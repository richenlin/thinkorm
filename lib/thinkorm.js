                                ...
                                return _regenerator2.default.wrap(function _callee3$(_context3) {
                                    while (1) {
                                        switch (_context3.prev = _context3.next) {
                                            ...
                                            case 2:
                                                _context3.next = 4;
                                                return _this2.parseOptions(options);
                                            ...
                                            case 13:
                                                _this2._data = _context3.sent;
                                                _context3.next = 16;
                                                return _this2.initDb().addAll(_this2._data, parsedOptions);
                                                            ...
                                                            switch (_context2.prev = _context2.next) {
                                                                ...
                                                                case 2:
                                                                    ...
                                                                    result.forEach(function (v, k) {
                                                                        _this2._data[k][pk] = v;
                                                                        resData.push(_this2._afterAdd(_this2._data[k], parsedOptions).then(function () {
                                                                            return v;
                                                                        }));
                                                                    });
