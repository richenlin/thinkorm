...
var _class = function (_base) {
    ...
    _class.prototype.connect = function connect() {
        ...
        if (this.config.db_ext_config.read_write && _lib2.default.isArray(this.config.db_host)) {
            ...
            return _promise2.default.all([_postgresql2.default.getInstance(configMaster), _postgresql2.default.getInstance(configSlave)]).then(function (cons) {
            ...
            this.handel = _postgresql2.default.getInstance(this.config);
            return _promise2.default.resolve(this.handel);
        }
    };
