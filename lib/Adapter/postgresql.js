...
var _class = function (_base) {
    ...
    _class.prototype.connect = function connect() {
        ...
        if (this.config.db_ext_config.read_write && _lib2.default.isArray(this.config.db_host)) {
            ...
            return _promise2.default.all([_postgresql2.default.getInstance(configMaster).connect(), _postgresql2.default.getInstance(configSlave).connect()]).then(function (cons) {
            ...
            this.handel = _postgresql2.default.getInstance(this.config).connect();
            return this.handel;
        }
    };
    ...
    _class.prototype.native = function native(tableName, sqlStr) {
        ...
        return this.connect().then(function (conn) {
            ...
            _this6.close();
            _this6.logSql && _lib2.default.log(sql, 'PostgreSQL', startTime);
            return _promise2.default.reject(err);
        }).then(function () {
            ...
            return _this6.formatData(res.rows);
        }).catch(function (err) {
            connection.release && connection.release();
            _this6.logSql && _lib2.default.log(ouputs.sql, 'PostgreSQL', startTime);
            return _promise2.default.reject(err);
