...
var _class = function (_base) {
    ...
    _class.prototype.__getHasManyRelation = function __getHasManyRelation(config, rel, data) {
        ...
        var primaryPk = _lib2.default.isObject(data[rel.primaryPk]) ? _lib2.default.toString(data[rel.primaryPk]) : data[rel.primaryPk];
    ...
    _class.prototype.__getManyToManyRelation = function __getManyToManyRelation(config, rel, data) {
        ...
        return mapModel.field(rel.fkey).select({ where: (_where3 = {}, _where3[rel.fkey] = data[rel.primaryPk], _where3) }).then(function (result) {
            var _where4;
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 3:
                            ...
                            _context2.next = _context2.t0 === 'ADD' ? 7 : _context2.t0 === 'UPDATE' ? 33 : 51;
                            break;
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        ...
                        case 16:
                            ...
                            _context3.next = _context3.t0 === 'ADD' ? 20 : _context3.t0 === 'UPDATE' ? 28 : 37;
                            break;
