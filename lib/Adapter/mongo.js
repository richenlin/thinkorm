...
var _class = function (_base) {
    ...
    _class.prototype.count = function count(field, options) {
        ...
        return this.parsers().buildSql(field, options).then(function (sql) {
            return _this10.execute(sql, field);
        }).then(function (data) {
    ...
    _class.prototype.sum = function sum(field, options) {
        ...
        options.method = 'sum';
        return this.parsers().buildSql(field, options).then(function (sql) {
            return _this11.execute(sql, field);
        }).then(function (data) {
            return data[0].count || 0;
        });
    };
    ...
    _class.prototype.avg = function avg(field, options) {
        var _this12 = this;

        options.method = 'avg';
        return this.parsers().buildSql(field, options).then(function (sql) {
            return _this12.execute(sql, field);
        }).then(function (data) {
            console.log(data);
            return data[0].count || 0;
        });
    ...
    _class.prototype.max = function max(field, options) {
        var _this13 = this;

        options.method = 'max';
        return this.parsers().buildSql(field, options).then(function (sql) {
            return _this13.execute(sql, field);
        }).then(function (data) {
            console.log(data);
            return data[0].count || 0;
        });
    ...
    _class.prototype.min = function min(field, options) {
        var _this14 = this;

        options.method = 'min';
        return this.parsers().buildSql(field, options).then(function (sql) {
            return _this14.execute(sql, field);
        }).then(function (data) {
            return data[0].count || 0;
        });
    };
