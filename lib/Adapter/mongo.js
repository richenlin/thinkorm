...
var _class = function (_base) {
    ...
    _class.prototype.native = function native(table, sqlArr) {
        ...
        return this.connect().then(function (conn) {
            ...
            _this3.sql = 'db.getCollection(\'' + table + '\')' + sqlArr.join('.');
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 4:
                            ...
                            _context2.next = _context2.t0 === 'ADD' ? 8 : _context2.t0 === 'UPDATE' ? 36 : 56;
                            break;
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        ...
                        case 17:
                            ...
                            _context3.next = _context3.t0 === 'ADD' ? 23 : _context3.t0 === 'UPDATE' ? 31 : 40;
                            break;
