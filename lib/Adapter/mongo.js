...
var _class = function (_base) {
    ...
    _class.prototype.native = function native(table, sqlArr) {
        var _this3 = this;
        ...
        return this.connect().then(function (conn) {
            ...
            _this3.sql = 'db.' + table + sqlArr.join('.');
    ...
    _class.prototype.add = function add(data) {
        ...
        return this.connect().then(function (conn) {
            ...
            _this4.sql = 'db.' + res.options.table + '.insertOne(' + (0, _stringify2.default)(res.data) + ')';
    ...
    _class.prototype.delete = function _delete() {
        ...
        return this.connect().then(function (conn) {
            ...
            _this5.sql = 'db.' + res.options.table + (res.options.where ? '.remove(' + (0, _stringify2.default)(res.options.where) + ')' : '.remove()');
    ...
    _class.prototype.update = function update(data) {
        ...
        return this.connect().then(function (conn) {
            ...
            _this6.sql = 'db.' + res.options.table + (res.options.where ? '.update(' + (0, _stringify2.default)(res.options.where) + ', {$set:' + (0, _stringify2.default)(res.data) + '}, false, true)' : '.update({}, {$set:' + (0, _stringify2.default)(res.data) + '}, false, true)');
    ...
    _class.prototype.increment = function increment(data, field) {
        ...
        return this.connect().then(function (conn) {
            ...
            _this7.sql = 'db.' + res.options.table + (res.options.where ? '.update(' + (0, _stringify2.default)(res.options.where) + ', {$inc:' + (0, _stringify2.default)(res.data) + ', false, true)' : '.update({}, {$inc:{' + field + ':' + data[field] + '}, false, true)');
    ...
    _class.prototype.decrement = function decrement(data, field) {
        ...
        return this.connect().then(function (conn) {
            ...
            _this8.sql = 'db.' + res.options.table + (res.options.where ? '.update(' + (0, _stringify2.default)(res.options.where) + ', {$inc:' + (0, _stringify2.default)(res.data) + ', false, true)' : '.update({}, {$inc:{' + field + ':' + (0 - data[field]) + '}, false, true)');
    ...
    _class.prototype.count = function count(field) {
        ...
        return this.connect().then(function (conn) {
            ...
            if (_lib2.default.isEmpty(res.options.group)) {
                ...
                _this9.sql = 'db.' + res.options.table + '.aggregate(' + (0, _stringify2.default)(pipe) + ')';
                handler = fn(pipe);
            } else {
                ...
                _this9.sql = 'db.' + res.options.table + '.group(' + (0, _stringify2.default)(res.options.group) + ')';
    ...
    _class.prototype.sum = function sum(field) {
        ...
        return this.connect().then(function (conn) {
            ...
            if (_lib2.default.isEmpty(res.options.group)) {
                ...
                _this10.sql = 'db.' + res.options.table + '.aggregate(' + (0, _stringify2.default)(pipe) + ')';
                handler = fn(pipe);
            } else {
                res.options.group.initial = {
                    "sumid": 0
                ...
                res.options.group.cond = res.options.where;
                _this10.sql = 'db.' + res.options.table + '.group(' + (0, _stringify2.default)(res.options.group) + ')';
                handler = collection.group(res.options.group);
            }
    ...
    _class.prototype.find = function find() {
        ...
        return this.connect().then(function (conn) {
            ...
            if (_lib2.default.isEmpty(res.options.group)) {
                _this11.sql = 'db.' + res.options.table + (res.options.where ? '.findOne(' + (0, _stringify2.default)(res.options.where) + ')' : '.findOne()');
                handler = collection.findOne(res.options.where || {});
            } else {
                res.options.group.cond = res.options.where;
                _this11.sql = 'db.' + res.options.table + '.group(' + res.options.group.key + ',' + res.options.group.cond + ',' + res.options.group.initial + ',' + res.options.group.reduce + ')';
                //handler = collection.group(res.options.group);
    ...
    _class.prototype.select = function select() {
        ...
        return this.connect().then(function (conn) {
            ...
            if (_lib2.default.isEmpty(res.options.group)) {
                _this12.sql = 'db.' + res.options.table + (res.options.where ? '.find(' + (0, _stringify2.default)(res.options.where) + ')' : '.find()');
                handler = collection.find(res.options.where || {});
            } else {
                res.options.group.cond = res.options.where;
                _this12.sql = 'db.' + res.options.table + '.group(' + res.options.group.key + ',' + res.options.group.cond + ',' + res.options.group.initial + ',' + res.options.group.reduce + ')';
                //handler = collection.group(res.options.group);
                handler = collection.group(res.options.group.key, res.options.group.cond, res.options.group.initial, res.options.group.reduce);
            }
