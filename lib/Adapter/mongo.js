...
var _class = function (_base) {
    ...
    _class.prototype.add = function add(data) {
        ...
        return this.connect().then(function (conn) {
            ...
            return _this3.parsers().buildSql(data, options);
        }).then(function (res) {
            _this3.sql = 'db.' + res.options.table + '.insertOne(' + (0, _stringify2.default)(res.data) + ')';
            return _this3.execute(collection.insertOne(res.data), startTime);
        }).then(function (data) {
    ...
    _class.prototype.delete = function _delete() {
        ...
        return this.connect().then(function (conn) {
            ...
            return _this4.execute(collection.deleteMany(res.options.where || {}), startTime);
        }).then(function (data) {
    ...
    _class.prototype.update = function update(data) {
        ...
        return this.connect().then(function (conn) {
            ...
            return _this5.execute(collection.updateMany(res.options.where || {}, res.data), startTime);
        }).then(function (data) {
