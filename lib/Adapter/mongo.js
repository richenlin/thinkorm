...
var _class = function (_base) {
    ...
    _class.prototype.increment = function increment(data, field) {
        ...
        return this.connect().then(function (conn) {
            ...
            _this7.sql = 'db.' + res.options.table + (res.options.where ? '.update(' + (0, _stringify2.default)(res.options.where) + ', {$inc:{' + field + ':' + data[field] + '}, false, true)' : '.update({}, {$inc:{' + field + ':' + data[field] + '}, false, true)');
    ...
    _class.prototype.decrement = function decrement(data, field) {
        ...
        return this.connect().then(function (conn) {
            ...
            _this8.sql = 'db.' + res.options.table + (res.options.where ? '.update(' + (0, _stringify2.default)(res.options.where) + ', {$inc:{' + field + ':' + (0 - data[field]) + '}, false, true)' : '.update({}, {$inc:{' + field + ':' + (0 - data[field]) + '}, false, true)');
