...
var _class = function (_base) {
    ...
    _class.prototype.migrate = function migrate(schema, config) {
        ...
        return this.query(this.knexClient.schema.hasTable(tableName).toString()).then(function (exists) {
            if (_lib2.default.isEmpty(exists)) {
                ...
                return _this3.execute(_this3.knexClient.schema.dropTableIfExists(tableName).toString());
            }
        }).then(function () {
            var options = {
                method: 'MIGRATE',
    ...
    _class.prototype.native = function native(sqlStr) {
        ...
        return this.connect().then(function (conn) {
            ...
            return _this6.bufferToString(rows);
        }).catch(function (err) {
            _this6.logSql && _lib2.default.log(ouputs.sql, 'MySQL', startTime);
            return _promise2.default.reject(err);
        });
    ...
    _class.prototype.__postHasOneRelation = function () {
        ...
        function __postHasOneRelation(_x12, _x13, _x14, _x15, _x16, _x17) {
    ...
    _class.prototype.__postHasManyRelation = function () {
        ...
        function __postHasManyRelation(_x18, _x19, _x20, _x21, _x22, _x23) {
    ...
    _class.prototype.__postManyToManyRelation = function () {
        ...
        function __postManyToManyRelation(_x24, _x25, _x26, _x27, _x28, _x29) {
