...
var _class = function (_base) {
    ...
    _class.prototype.connect = function connect() {
        ...
        if (this.config.db_ext_config.read_write && _lib2.default.isArray(this.config.db_host)) {
            ...
            return _promise2.default.all([new _mysql2.default(configMaster).connect(), new _mysql2.default(configSlave).connect()]).then(function (cons) {
    ...
    _class.prototype.__getManyToManyRelation = function __getManyToManyRelation(config, rel, data) {
        ...
        return mapModel.field(rel.rkey).select({ where: (_where3 = {}, _where3[rel.fkey] = data[rel.primaryPk], _where3) }).then(function (result) {
            var _where4;
