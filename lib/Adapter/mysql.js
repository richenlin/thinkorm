...
var _knexBase = require('../Parser/knexBase');

var _knexBase2 = _interopRequireDefault(_knexBase);
...
var _class = function (_base) {
    ...
    _class.prototype.connect = function connect() {
        ...
        if (this.config.db_ext_config.read_write && _lib2.default.isArray(this.config.db_host)) {
            ...
            return _promise2.default.all([_mysql2.default.getInstance(configMaster), _mysql2.default.getInstance(configSlave)]).then(function (cons) {
            ...
            this.handel = _mysql2.default.getInstance(this.config);
            return this.handel;
        }
    };
    ...
    _class.prototype.parsers = function parsers() {
        ...
        this.parsercls = new _knexBase2.default(this.config);
        return this.parsercls;
    };
    ...
    _class.prototype.execute = function execute(sql) {
        ...
        return this.connect().then(function (conn) {
            ...
            //when socket is closed, try it
            if (err.code === 'PROTOCOL_CONNECTION_LOST' || err.code === 'EPIPE') {
                return _this5.close().then(function () {
