...
var _knex3 = require('../Parser/knex');

var _knex4 = _interopRequireDefault(_knex3);
...
var _class = function (_base) {
    ...
    _class.prototype.connect = function connect() {
        ...
        //读写分离配置
        if (this.config.db_ext_config.read_write && _lib2.default.isArray(this.config.db_host)) {
            var configMaster = {
            ...
            return _promise2.default.all([_mysql2.default.getInstance(configMaster).connect(), _mysql2.default.getInstance(configSlave).connect()]).then(function (cons) {
            ...
            this.handel = _mysql2.default.getInstance(this.config).connect();
            return this.handel;
        }
    };
    ...
    _class.prototype.parsers = function parsers() {
        ...
        this.parsercls = new _knex4.default(this.config);
        return this.parsercls;
    };
    ...
    _class.prototype.query = function query(sql) {
        ...
        return this.connect().then(function (conn) {
            ...
            _this4.close();
            _this4.logSql && _lib2.default.log(sql, 'MySQL', startTime);
    ...
    _class.prototype.execute = function execute(sql) {
        ...
        return this.connect().then(function (conn) {
            ...
            _this5.close();
            _this5.logSql && _lib2.default.log(sql, 'MySQL', startTime);
            return _promise2.default.reject(err);
        }).then(function () {
            var rows = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    ...
    _class.prototype.native = function native(tableName, sqlStr) {
        ...
        return this.connect().then(function (conn) {
            ...
            _this6.close();
            _this6.logSql && _lib2.default.log(sql, 'MySQL', startTime);
            return _promise2.default.reject(err);
        }).then(function () {
            var rows = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

            connection.release && connection.release();
            _this6.logSql && _lib2.default.log(ouputs.sql, 'MySQL', startTime);
            return _this6.formatData(rows);
        }).catch(function (err) {
            connection.release && connection.release();
            _this6.logSql && _lib2.default.log(ouputs.sql, 'MySQL', startTime);
            return _promise2.default.reject(err);
    ...
    _class.prototype.commit = function commit() {
        ...
        if (this.transTimes > 0) {
            this.transTimes = 0;
            return this.execute('COMMIT').then(function (data) {
                _this7.close();
                return data;
            });
        }
    ...
    _class.prototype.rollback = function rollback() {
        ...
        if (this.transTimes > 0) {
            this.transTimes = 0;
            return this.execute('ROLLBACK').then(function (data) {
                _this8.close();
                return data;
            });
        }
    ...
    _class.prototype.increment = function increment(data, field) {
        ...
        return this.parsers().buildSql(knexCls, data, options).then(function (sql) {
            return _this12.execute(sql);
        }).then(function (res) {
            //更新前置操作内会改变data的值
            if (!_lib2.default.isEmpty(data)) {
                _this12.update(data, options);
            }
            return res;
        });
    };
    ...
    _class.prototype.decrement = function decrement(data, field) {
        ...
        knexCls = knexCls.from(options.table);
        return this.parsers().buildSql(knexCls, data, options).then(function (sql) {
            return _this13.execute(sql);
        }).then(function (res) {
            //更新前置操作内会改变data的值
            if (!_lib2.default.isEmpty(data)) {
                _this13.update(data, options);
            }
            return res;
        });
    };
    ...
    _class.prototype.count = function count(field) {
        ...
        var knexCls = this.knexClient.count(field + ' AS count').from(options.table + ' AS ' + options.alias);
        return this.parsers().buildSql(knexCls, options).then(function (sql) {
    ...
    _class.prototype.sum = function sum(field) {
        ...
        options.limit = [0, 1];
        field = field || options.alias + '.' + options.pk;
        var knexCls = this.knexClient.sum(field + ' AS sum').from(options.table + ' AS ' + options.alias);
        return this.parsers().buildSql(knexCls, options).then(function (sql) {
    ...
    _class.prototype.find = function find() {
        ...
        options.limit = [0, 1];
        var knexCls = this.knexClient.select().from(options.table + ' AS ' + options.alias);
        return this.parsers().buildSql(knexCls, options).then(function (sql) {
            return _this16.query(sql);
        }).then(function (data) {
            //
            return data;
        });
    ...
    _class.prototype.__checkData = function __checkData(data, type) {
        var typeCase = { json: 1, array: 1 };
        if (!_lib2.default.isString(data) && typeCase[type]) {
    ...
    _class.prototype.__parseData = function __parseData(data, fields) {
        // let typeCase = {json: 1, array: 1};
        //处理特殊类型字段
        if (_lib2.default.isArray(data)) {
            data.map(function (item) {
                for (var n in item) {
                    if (_lib2.default.isJSONStr(item[n])) {
                        try {
            ...
            for (var n in data) {
                if (_lib2.default.isJSONStr(data[n])) {
                    try {
    ...
    _class.prototype.__getManyToManyRelation = function __getManyToManyRelation(config, rel, data) {
        ...
        return mapModel.field(rel.rkey).select({ where: (_where3 = {}, _where3[rel.fkey] = data[rel.primaryPk], _where3) }).then(function (data) {
            var _where4;
                    ...
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 3:
                            ...
                            return _context2.delegateYield(_regenerator2.default.mark(function _callee() {
                                ...
                                var fkey, condition, keys, info, _condition$in;
                                    ...
                                    while (1) {
                                        switch (_context.prev = _context.next) {
                                            case 0:
                                                ...
                                                _context.next = _context.t0 === 'ADD' ? 3 : _context.t0 === 'UPDATE' ? 11 : 22;
                                                break;
                    ...
                    switch (_context4.prev = _context4.next) {
                        ...
                        case 3:
                            ...
                            return _context4.delegateYield(_regenerator2.default.mark(function _callee3() {
                                var _iterator, _isArray, _i, _ref3, _ref4, k, v, condition, keys, primaryModel, info, _condition$in2, _iterator2, _isArray2, _i2, _ref5, _ref6;
                                    ...
                                    while (1) {
                                        switch (_context3.prev = _context3.next) {
                                            case 0:
                                                ...
                                                _context3.next = _context3.t0 === 'ADD' ? 3 : _context3.t0 === 'UPDATE' ? 21 : 47;
                                                break;
                                            ...
                                            case 14:
                                                _ref4 = _ref3, k = _ref4[0], v = _ref4[1];
                                            ...
                                            case 40:
                                                _ref6 = _ref5, k = _ref6[0], v = _ref6[1];
                    ...
                    switch (_context6.prev = _context6.next) {
                        ...
                        case 3:
                            ...
                            return _context6.delegateYield(_regenerator2.default.mark(function _callee5() {
                                ...
                                var _iterator3, _isArray3, _i3, _mapModel$thenAdd, _where6, _ref8, _ref9, k, v, fkey, condition, keys, primaryModel, info, _condition$in3, _iterator4, _isArray4, _i4, _ref10, _ref11, _mapModel$thenAdd2, _where7;
                                    ...
                                    while (1) {
                                        switch (_context5.prev = _context5.next) {
                                            case 0:
                                                ...
                                                _context5.next = _context5.t0 === 'ADD' ? 3 : _context5.t0 === 'UPDATE' ? 25 : 56;
                                                break;
                                            ...
                                            case 14:
                                                _ref9 = _ref8, k = _ref9[0], v = _ref9[1];
                                                _context5.next = 17;
                                                return model.add(v);
                                            ...
                                            case 44:
                                                _ref11 = _ref10, k = _ref11[0], v = _ref11[1];
