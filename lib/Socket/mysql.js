...
var _class = function (_base) {
    ...
    _class.prototype.connect = function connect() {
        ...
        return _lib2.default.await(connectKey, function () {
            //use pool
            if (_this2.connectionLimit) {
                _this2.pool = _mysql2.default.createPool(config);
                var fn = _lib2.default.promisify(_this2.pool.getConnection, _this2.pool);
