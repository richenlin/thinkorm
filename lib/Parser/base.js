            ...
            case 'IN':
                for (var _n in value) {
                    if (_lib2.default.isArray(value[_n])) {
                        isor ? options.orwhere.in.push(['' + _alias + _n, value[_n]]) : options.where.in.push(['' + _alias + _n, value[_n]]);
                    }
                }
                break;
            case 'NOTIN':
                for (var _n2 in value) {
                    if (_lib2.default.isArray(value[_n2])) {
                        isor ? options.orwhere.notin.push(['' + _alias + _n2, value[_n2]]) : options.where.notin.push(['' + _alias + _n2, value[_n2]]);
                    }
                }
                break;
            case 'NOT':
                for (var _n3 in value) {
                    if (_lib2.default.isArray(value[_n3])) {
                        isor ? options.orwhere.notin.push(['' + alias + _n3, value[_n3]]) : options.where.notin.push(['' + _alias + _n3, value[_n3]]);
                    } else {
                        isor ? options.orwhere.not.push(['' + _alias + _n3, value[_n3]]) : options.where.not.push(['' + _alias + _n3, value[_n3]]);
                    }
                }
                break;
            case 'OPERATOR':
...
var parseKnexOrWhere1 = function parseKnexOrWhere1(knex, optionOrWhere, optionWhere) {
    var hasOr = false;
    if (optionOrWhere.and) {
        hasOr = true;
        optionOrWhere.and.map(function (data) {
