...
exports.default = class extends _base2.default {
    ...
    parseSchema(cls, data, options) {
        ...
        let tableName = `${data.db_prefix}${_lib2.default.parseName(options.schema.name)}`;
        let str = [],
            ...
            try {
                ...
                if (cls) {
                    ...
                    if (options.join && caseList[optType].join) {
                        yield _this.parseJoin(cls, data, options);
                    ...
                    for (let n in options) {
                        if (caseList[optType][n]) {
                            ...
                            mt && _lib2.default.isFunction(_this[mt]) && (yield _this[mt](cls, data, options));
                        }
                    }
                    return cls.toString();
                }
