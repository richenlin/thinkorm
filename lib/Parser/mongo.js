...
var _class = function (_base) {
    ...
    _class.prototype.parseWhere = function parseWhere(data, options) {
        ...
        //将主键转为ObjectID
        options.pk && options.where[options.pk] && (options.where[options.pk] = new _mongodb.ObjectID(options.where[options.pk]));
    };
    ...
    _class.prototype.parseMethod = function parseMethod(collection, data, options) {
        ...
        if (optType && optType in caseList) {
            ...
            if (optType == 'SELECT' && _lib2.default.isEmpty(options.group)) {
    ...
    _class.prototype.parseSql = function () {
        var _ref7 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(conn, data, options) {
    ...
    _class.prototype.buildSql = function () {
        var _ref8 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(conn, data, options) {
            var parseOptions;
